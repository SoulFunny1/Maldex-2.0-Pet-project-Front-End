    ...
    >
      ...
      >
        ...
        <div className="flex mb-8 bg-gray-100 rounded-lg overflow-hidden shadow-inner-sm">
          ...
          <button
            className="flex-grow py-3 px-4 text-white font-semibold text-base bg-gray-800 transition duration-200 ease-in-out shadow-md"
          >
            Регистрация
          </button>
        </div>

        <h3 className="text-2xl font-bold text-gray-800 mb-6 text-center">Создать аккаунт</h3>
